...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'cap3qi1tpelmohammed@viva-technology.org' # this email will be used to send emails
EMAIL_HOST_PASSWORD = 'Mohammed@2005' # host email password required
